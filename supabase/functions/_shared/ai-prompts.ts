...
// =============================================================================
// IP-SPECIFIC CLAUSE LIBRARY (Patent, Trademark, License)
// =============================================================================

export const IP_CLAUSE_LIBRARY = `
## PATENT ASSIGNMENT CLAUSES

### Patent Identification and Grant
"The Assignor hereby assigns, transfers, and conveys to the Assignee, its successors and assigns, all of the Assignor's right, title, and interest in and to:
(a) Australian Patent Application No. [NUMBER] entitled '[TITLE]' filed on [DATE];
(b) Australian Patent No. [NUMBER] entitled '[TITLE]' granted on [DATE];
(c) Any and all divisional, continuation, continuation-in-part applications, and reissues thereof;
(d) All corresponding foreign patent applications and patents claiming priority from the above; and
(e) All rights to claim priority under the Paris Convention or Patent Cooperation Treaty."

### Chain of Title Warranty
"The Assignor warrants and represents that:
(a) The Assignor is the sole legal and beneficial owner of the Patent(s);
(b) The Assignor has full right and authority to assign the Patent(s);
(c) The Patent(s) are free and clear of all liens, encumbrances, security interests, and adverse claims;
(d) No litigation is pending or threatened regarding the Patent(s);
(e) All maintenance fees and annuities have been paid to date; and
(f) The Assignor has not granted any licenses or rights inconsistent with this assignment."

### IP Australia Recordation
"The Parties agree that:
(a) This Assignment shall be recorded with IP Australia within [30] days of execution;
(b) The [Assignor/Assignee] shall be responsible for preparing and filing the request for recordation;
(c) The [other party] shall execute all documents and take all actions reasonably required to effect such recordation;
(d) The costs of recordation shall be borne by the [Assignee/shared equally]; and
(e) The Assignor shall provide all documents evidencing chain of title as required by IP Australia."

### Inventor Confirmation
"Each inventor named in the Patent(s) has executed an invention assignment agreement assigning all rights to the Assignor, and the Assignor shall provide copies of such agreements upon request."

### Further Assurances (IP)
"The Assignor agrees to execute and deliver all such further instruments, and to take all such further action, as the Assignee may reasonably request to perfect, confirm, and evidence the Assignee's ownership of the Patent(s), including but not limited to executing confirmatory assignments for recordation in Australia and any foreign jurisdictions."

## TRADEMARK ASSIGNMENT CLAUSES

### Trademark Grant with Goodwill
"The Assignor hereby assigns, transfers, and conveys to the Assignee, together with the goodwill of the business symbolized thereby:
(a) Australian Trade Mark Registration No. [NUMBER] for the mark '[MARK]' in Classes [CLASSES];
(b) Australian Trade Mark Application No. [NUMBER] for the mark '[MARK]';
(c) All common law rights in the mark '[MARK]' used in Australia;
(d) The right to sue for past, present, and future infringement of the foregoing; and
(e) All corresponding foreign trademark registrations and applications."

### Trade Marks Act Compliance
"This assignment is made in accordance with Section 106 of the Trade Marks Act 1995 (Cth), and the Parties acknowledge that:
(a) The trade mark is being assigned together with the goodwill of the business concerned in the relevant goods/services;
(b) The assignment will not result in different persons having the right to use the trade mark in relation to the same goods/services, or to closely related goods/services; and
(c) The Assignee undertakes to use the trade mark in a manner consistent with its registration and not in a way likely to deceive or cause confusion."

### Domain Names and Social Media
"The assignment includes all domain name registrations incorporating or substantially similar to the Trade Mark(s), including but not limited to [LIST DOMAINS], and all social media accounts associated with the Trade Mark(s), including but not limited to [LIST ACCOUNTS]. The Assignor shall cooperate in transferring administrative control of such assets within [14] days of Completion."

### Quality Standards (Trademark)
"The Assignee acknowledges the importance of maintaining the quality and reputation associated with the Trade Mark(s) and agrees to:
(a) Maintain quality standards substantially similar to those maintained by the Assignor;
(b) Not use the Trade Mark(s) in any manner that would be likely to damage the reputation or distinctiveness of the marks; and
(c) Use the Trade Mark(s) only in connection with goods/services of a quality consistent with the goodwill assigned."

## IP LICENSE AGREEMENT CLAUSES

### License Grant (Exclusive)
"Subject to the terms and conditions of this Agreement, the Licensor hereby grants to the Licensee an exclusive licence under the Licensed IP to [make, have made, use, sell, offer for sale, and import] products and services within the Field of Use in the Territory during the Term. 'Exclusive' means that the Licensor shall not grant any other licences under the Licensed IP within the Field of Use in the Territory, and the Licensor itself shall not exercise such rights."

### License Grant (Non-Exclusive)
"Subject to the terms and conditions of this Agreement, the Licensor hereby grants to the Licensee a non-exclusive licence under the Licensed IP to [make, have made, use, sell, offer for sale, and import] products and services within the Field of Use in the Territory during the Term. The Licensor retains the right to grant similar licences to third parties and to exercise all rights under the Licensed IP."

### Royalty Provisions
"In consideration of the rights granted herein, the Licensee shall pay to the Licensor:
(a) An upfront fee of $[AMOUNT] payable upon execution;
(b) A running royalty of [X]% of Net Sales of Licensed Products;
(c) Minimum annual royalties of $[AMOUNT] per year, creditable against earned royalties; and
(d) All royalties shall be calculated and paid quarterly within [30] days of each calendar quarter end."

### Audit Rights
"The Licensee shall maintain complete and accurate records of all Licensed Products manufactured, sold, and distributed. The Licensor shall have the right, upon [30] days' prior written notice and not more than once per calendar year, to audit the Licensee's records to verify royalty calculations. Any underpayment shall be promptly corrected with interest at [RBA cash rate + 4]%."

### IP Ownership and Improvements
"The Licensor retains all right, title, and interest in and to the Licensed IP. Any improvements, modifications, or derivative works created by the Licensee ('Improvements') shall be [owned by the Licensor and automatically licensed to the Licensee / jointly owned / owned by the Licensee with a licence back to the Licensor]."

### Infringement
"Each Party shall promptly notify the other of any infringement or suspected infringement of the Licensed IP. The [Licensor/Licensee/Parties jointly] shall have the right, but not the obligation, to bring proceedings against infringers. Any recovery shall be [divided equally / allocated first to reimburse enforcement costs, then divided]."

### Termination of License
"This Agreement may be terminated:
(a) By either party upon [90] days' written notice;
(b) By either party upon material breach that remains uncured for [30] days after written notice;
(c) Immediately by the Licensor if the Licensee challenges the validity of any Licensed IP;
(d) Immediately by either party upon the insolvency or bankruptcy of the other party.
Upon termination, all rights granted hereunder shall immediately revert to the Licensor, and the Licensee shall cease all use of the Licensed IP."
`;

// =============================================================================
// IP AUSTRALIA REGULATORY CONTEXT
// =============================================================================

export const IP_AUSTRALIA_CONTEXT = `
## Australian Intellectual Property Regulatory Framework

### Patents - Patents Act 1990 (Cth)
- IP Australia is the governing body for patent registration and administration
- Standard patents provide 20 years of protection from filing date
- Innovation patents (phased out 25 August 2021) provided 8 years but existing registrations remain valid
- Assignments must be recorded with IP Australia to be effective against third parties
- Recording fee applies (check current IP Australia schedule)
- Form: Request to Record a Change in Ownership

### Trade Marks - Trade Marks Act 1995 (Cth)
- Registration provides 10 years of protection, renewable indefinitely
- Assignments must be recorded with IP Australia within 6 months (or as soon as practicable)
- Section 106: Assignment must be with goodwill to avoid potential invalidity
- Unregistered marks protected by common law passing off
- Recording form: Request to Record Assignment of Trade Mark

### Copyright - Copyright Act 1968 (Cth)
- Automatic protection, no registration required in Australia
- Assignment must be in writing and signed by assignor (Section 196)
- Moral rights cannot be assigned but can be consented to
- Duration: generally life of author + 70 years

### Designs - Designs Act 2003 (Cth)
- Registration provides up to 10 years of protection
- Assignments must be recorded with IP Australia
- Certification required for enforcement

### Recordation Procedures
All IP assignments/transfers should be recorded with IP Australia:
- Online via IP Australia's online services portal
- Required information: parties, IP registration numbers, effective date, consideration (optional)
- Evidence of assignment (copy of agreement, short form assignment)
- Current fees: check IP Australia website for latest schedule

### Cross-Border Considerations
- Foreign nationals can own Australian IP
- No FIRB approval required for IP transactions alone
- Consider tax implications: royalty withholding, transfer pricing
- Paris Convention / PCT priority claims for patents
- Madrid Protocol for international trademark filings
`;
