...
const MilestoneItem: React.FC<MilestoneItemProps> = ({ 
  ...
  const handleDocumentSelected = async (documentId: string, selectedBuyerId?: string) => {
    if (!user) return;

    try {
      console.log('Starting DocuSign process for document:', documentId, 'buyer:', selectedBuyerId);
