...
const NavBar = () => {
  ...
  return (
    <AppErrorBoundary>
      <header className="sticky top-0 z-40 border-b bg-background/95 backdrop-blur-sm overflow-visible">
        <div className="h-16 px-4 md:px-6 flex items-center justify-between overflow-visible">
          {/* Logo */}
